...
describe('stripAnsi', () => {
  ...
  it('strips complex CSI sequences (SGR, cursor movement)', () => {
    expect(stripAnsi('\x1b[1;32;45m bold green on magenta \x1b[0m')).toBe(' bold green on magenta ');
  });
  ...
  it('strips OSC sequences with ST terminator', () => {
    expect(stripAnsi('\x1b]8;id=foo;https://example.com\x1b\\link text\x1b]8;;\x1b\\')).toBe('link text');
  });
