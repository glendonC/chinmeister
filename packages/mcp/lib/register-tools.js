...
// Team coordination tools plus local integration doctor tools + 1 resource.

import { basename } from 'path';
import * as z from 'zod/v4';
import { configureHostIntegration, scanHostIntegrations } from '../../shared/integration-doctor.js';
import {
  refreshContext,
  teamPreamble,
  offlinePrefix,
...
export function registerTools(server, { team, state, profile, integrationDoctor = { scanHostIntegrations, configureHostIntegration } }) {
