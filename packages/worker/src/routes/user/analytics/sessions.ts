...
// Key is file (not handle:file). Attempts sum across teams because the same
// path appearing in team-A and team-B genuinely means more pain for this
// user. Agents is max-across-teams: the union of distinct counts is not
// itself a distinct count, and max is a truthful lower bound when the same
// person may appear in multiple teams. Tools union normally because set
// semantics hold across teams.
